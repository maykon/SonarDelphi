...
public class SonarWayRecommendedProfile extends ProfileDefinition {
  ...
  public static final String PATH_TO_JSON = "org/sonar/l10n/delphi/rules/delphi/Sonar_way_recommended_profile.json";
  ...
  private void loadFromCommonRepository(RulesProfile profile) {
    Rule duplicatedBlocksRule = ruleFinder.findByKey("common-" + DelphiLanguage.KEY, "DuplicatedBlocks");
